...
| [`t2000-fund`](https://t2000.ai/skills/t2000-fund) | Share the wallet address, render an ANSI QR in terminal, or emit a Payment Kit `sui:pay?…` URI via MCP. Use for "share my address", "create a payment link", or "QR code". |
